...
const Navbar = () => {
  ...
  return (
    <div
      id="top"
      className="sticky top-0 z-50 w-full flex justify-center items-center pt-6 px-6 sm:px-10 md:px-20 "
    >
      <Link
        href="#top"
        className="absolute left-6 sm:left-10 lg:left-20 mt-10 lg:mt-0 w-20 md:w-36"
      >
      ...
      >
        {isOpen ? (
          ...
          <FiMenu
            size={28}
            className=" text-white block fixed top-7 right-10"
          />
        )}
      </div>
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed top-4 right-1 w-1/2 bg-[#1d4d3d] text-white p-6 shadow-md rounded-lg z-30 ${
          isOpen ? "block" : "hidden"
        } lg:hidden`}
      >
